...
class OrderControllerIntegrationTest {
    ...
    class createOrder {
        ...
        void shouldReturnBadRequestWhenItemsIsEmpty() throws Exception {
            CreateOrderRequest request =
                    new CreateOrderRequest("ORDER-001", Collections.emptyList());
        ...
        @Test
        void shouldReturnConflictWhenOrderAlreadyExists() throws Exception {
            CreateOrderRequest request =
                    new CreateOrderRequest(
                            "ORDER-001",
                            List.of(
            ...
            mockMvc.perform(
                    ...
                    .andExpect(
                            jsonPath("$.detail").value("Order with ID ORDER-001 already exists"));
        }
