...
class InventoryApplicationServiceTest {
    ...
    void shouldReserveInventorySuccessfully() {
        ...
        verify(inventoryTransactionRepository, atLeast(2)).save(any(InventoryTransaction.class));
    ...
    void shouldThrowExceptionWhenTransactionNotFoundForConsume() {
        ...
        when(inventoryTransactionRepository.findById("NON-EXISTENT")).thenReturn(Optional.empty());
